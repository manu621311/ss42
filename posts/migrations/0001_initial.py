    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genuine', models.ManyToManyField(blank=True, related_name='genuines', to=settings.AUTH_USER_MODEL)),
                ('spam', models.ManyToManyField(blank=True, related_name='spames', to=settings.AUTH_USER_MODEL)),
