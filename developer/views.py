...
class SaveToken(View):
    ...
    def post(self, request):
        ...
        try:
            User.objects.get(email=ss_email)
        except:
        ...
        if isTokenGen:
            return HttpResponse(f'<h2> Token already Generated </h2> <br> <h2> Token sent to your registered email. Please check it. </h2>')
        ...
        return HttpResponse(f'<h2> Token Generated Successfully: <h1> {dev.token} </h1> </h2> <br> <h2> And sent to your email </h2>')